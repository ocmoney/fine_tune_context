...
if __name__ == "__main__":
    ...
    while True:
        ...
        if user_prompt.lower() == "exit":
            break
        ref_knowledge = decoder.generate_response(user_prompt)
        print("\nResponse before training:", ref_knowledge)
    ...
    while True:
        ...
        if user_prompt.lower() == "exit":
            break
        neg_knowledge = decoder.generate_response(user_prompt)
        print("\nResponse after training:", neg_knowledge)
        pos_knowledge = input("\nEnter a better response: ")
        

    def train_with_dpo(self, pos_knowledge, neg_knowledge,ref_knowledge, num_epochs=1):